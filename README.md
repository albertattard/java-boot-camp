...
1. [Lists (Vector, ArrayList and LinkedList)](03%20-%20Collections.md#lists-vector-arraylist-and-linkedlist)
    ...
    1. [Types of Lists](03%20-%20Collections.md#types-of-lists)
        ...
        1. [Which List to Use?](03%20-%20Collections.md#which-list-to-use)
...
1. [Set (HashSet, LinkedHashSet and TreeSet)](03%20-%20Collections.md#set-hashset-linkedhashset-and-treeset)
    ...
    1. [Set values MUST BE Immutable](03%20-%20Collections.md#set-values-must-be-immutable)
    1. [Types of Sets](03%20-%20Collections.md#types-of-sets)
        ...
        1. [Which Set to Use?](03%20-%20Collections.md#which-set-to-use)
    1. [Mutable and Immutable Sets](03%20-%20Collections.md#mutable-and-immutable-sets)
1. [Map (Hashtable, HashMap, LinkedHashMap and TreeMap)](03%20-%20Collections.md#map-hashtable-hashmap-linkedhashmap-and-treemap)
    1. [Create Maps](03%20-%20Collections.md#create-maps)
    1. [Map Keys MUST BE Immutable](03%20-%20Collections.md#map-keys-must-be-immutable)
    1. [Types of Maps](03%20-%20Collections.md#types-of-maps)
        1. [Hashtable](03%20-%20Collections.md#hashtable)
        1. [HashMap](03%20-%20Collections.md#hashmap)
        1. [LinkedHashMap](03%20-%20Collections.md#linkedhashmap)
        1. [TreeMap](03%20-%20Collections.md#treemap)
        1. [Which Map to Use?](03%20-%20Collections.md#which-map-to-use)
    1. [Relation between Collections the Objects they contain](03%20-%20Collections.md#relation-between-collections-the-objects-they-contain)
        1. [List and the equals() method](03%20-%20Collections.md#list-and-the-equals-method)
        1. [Hash based Collections and the equals() and hashCode() methods](03%20-%20Collections.md#hash-based-collections-and-the-equals-and-hashcode-methods)
1. [Queue and Stack](03%20-%20Collections.md#queue-and-stack)
    1. [Queues](03%20-%20Collections.md#queues)
    1. [Stacks](03%20-%20Collections.md#stacks)
...
1. [Exceptions](04%20-%20Classes%2C%20Methods%20and%20Control%20Flow.md#exceptions)
    1. [Alternative Approach](04%20-%20Classes%2C%20Methods%20and%20Control%20Flow.md#alternative-approach)
...
1. [Interfaces](06%20-%20Objects.md#interfaces)
    1. [Default methods](06%20-%20Objects.md#default-methods)
...
1. [Overloading and Overriding](06%20-%20Objects.md#overloading-and-overriding)
    1. [Overloading](06%20-%20Objects.md#overloading)
    1. [Overriding](06%20-%20Objects.md#overriding)
1. [Outer, Inner and Anonymous Classes](06%20-%20Objects.md#outer-inner-and-anonymous-classes)
    1. [Outer Class](06%20-%20Objects.md#outer-class)
