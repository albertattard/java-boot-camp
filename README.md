...
1. [Gradle and Maven](01%20-%20Setup.md#gradle-and-maven)
    1. [Advantages of Gradle over Maven](01%20-%20Setup.md#advantages-of-gradle-over-maven)
...
1. [Hello World Application (packaged as an executable application)](01%20-%20Setup.md#hello-world-application-packaged-as-an-executable-application)
    1. [Gradle Task Dependency Tree](01%20-%20Setup.md#gradle-task-dependency-tree)
    1. [Project Dependencies](01%20-%20Setup.md#project-dependencies)
    1. [Package Project](01%20-%20Setup.md#package-project)
1. [Docker](01%20-%20Setup.md#docker)
    1. [Setup Docker](01%20-%20Setup.md#setup-docker)
    1. [Dockerize the Application](01%20-%20Setup.md#dockerize-the-application)
    1. [Multi-Stage Docker Build](01%20-%20Setup.md#multi-stage-docker-build)
...
### [Lambda](07%20-%20Lambda.md)

1. [Lambda Expressions](07%20-%20Lambda.md#lambda-expressions)
1. [Multiple Parameters](07%20-%20Lambda.md#multiple-parameters)
1. [Dealing with Exceptions](07%20-%20Lambda.md#dealing-with-exceptions)
1. [Foreach Loops](07%20-%20Lambda.md#foreach-loops)
1. [Streams (Lambda)](07%20-%20Lambda.md#streams-lambda)
1. [Mapping and Filtering](07%20-%20Lambda.md#mapping-and-filtering)
1. [Collectors](07%20-%20Lambda.md#collectors)

### [IO & Streams](08%20-%20IO%20&%20Streams.md)

1. [Files](08%20-%20IO%20&%20Streams.md#files)
1. [Java Streams](08%20-%20IO%20&%20Streams.md#java-streams)
1. [Java Non-Blocking IO](08%20-%20IO%20&%20Streams.md#java-non-blocking-io)
1. [HTTP Client (Java)](08%20-%20IO%20&%20Streams.md#http-client-java)

### [Databases](09%20-%20Databases.md)

1. [Data Sources (Hikari Connection Pool)](09%20-%20Databases.md#data-sources-hikari-connection-pool)
1. [H2, MySQL and PostgreSQL](09%20-%20Databases.md#h2-mysql-and-postgresql)
1. [Flyway (Database Migration)](09%20-%20Databases.md#flyway-database-migration)
1. [Statements, Prepared Statements, Result Sets](09%20-%20Databases.md#statements-prepared-statements-result-sets)
1. [Transactions](09%20-%20Databases.md#transactions)
1. [JOOQ](09%20-%20Databases.md#jooq)
1. [Query DSL](09%20-%20Databases.md#query-dsl)
1. [JPA and Hibernate](09%20-%20Databases.md#jpa-and-hibernate)

### [Concurrency](10%20-%20Concurrency.md)

1. [Threads](10%20-%20Concurrency.md#threads)
1. [Synchronized](10%20-%20Concurrency.md#synchronized)
1. [Deadlocks](10%20-%20Concurrency.md#deadlocks)
1. [Race Conditions](10%20-%20Concurrency.md#race-conditions)
1. [Executors and Schedulers](10%20-%20Concurrency.md#executors-and-schedulers)
1. [New Concurrent Primitives](10%20-%20Concurrency.md#new-concurrent-primitives)
1. [Fork Join Framework](10%20-%20Concurrency.md#fork-join-framework)

### [Common Design Patterns](11%20-%20Common%20Design%20Patterns.md)

1. [Creational Design Pattern](11%20-%20Common%20Design%20Patterns.md#creational-design-pattern)
    1. [Factory Pattern](11%20-%20Common%20Design%20Patterns.md#factory-pattern)
    1. [Abstract Factory Pattern](11%20-%20Common%20Design%20Patterns.md#abstract-factory-pattern)
    1. [Singleton Pattern](11%20-%20Common%20Design%20Patterns.md#singleton-pattern)
    1. [Prototype Pattern](11%20-%20Common%20Design%20Patterns.md#prototype-pattern)
    1. [Builder Pattern.](11%20-%20Common%20Design%20Patterns.md#builder-pattern)
1. [Structural Design Pattern](11%20-%20Common%20Design%20Patterns.md#structural-design-pattern)
    1. [Adapter Pattern](11%20-%20Common%20Design%20Patterns.md#adapter-pattern)
    1. [Bridge Pattern](11%20-%20Common%20Design%20Patterns.md#bridge-pattern)
    1. [Composite Pattern](11%20-%20Common%20Design%20Patterns.md#composite-pattern)
    1. [Decorator Pattern](11%20-%20Common%20Design%20Patterns.md#decorator-pattern)
    1. [Facade Pattern](11%20-%20Common%20Design%20Patterns.md#facade-pattern)
    1. [Flyweight Pattern](11%20-%20Common%20Design%20Patterns.md#flyweight-pattern)
    1. [Proxy Pattern](11%20-%20Common%20Design%20Patterns.md#proxy-pattern)
1. [Behavioral Design Pattern](11%20-%20Common%20Design%20Patterns.md#behavioral-design-pattern)
    1. [Chain Of Responsibility Pattern](11%20-%20Common%20Design%20Patterns.md#chain-of-responsibility-pattern)
    1. [Command Pattern](11%20-%20Common%20Design%20Patterns.md#command-pattern)
    1. [Interpreter Pattern](11%20-%20Common%20Design%20Patterns.md#interpreter-pattern)
    1. [Iterator Pattern](11%20-%20Common%20Design%20Patterns.md#iterator-pattern)
    1. [Mediator Pattern](11%20-%20Common%20Design%20Patterns.md#mediator-pattern)
    1. [Memento Pattern](11%20-%20Common%20Design%20Patterns.md#memento-pattern)
    1. [Observer Pattern](11%20-%20Common%20Design%20Patterns.md#observer-pattern)
    1. [State Pattern](11%20-%20Common%20Design%20Patterns.md#state-pattern)
    1. [Strategy Pattern](11%20-%20Common%20Design%20Patterns.md#strategy-pattern)
    1. [Template Pattern](11%20-%20Common%20Design%20Patterns.md#template-pattern)
    1. [Visitor Pattern](11%20-%20Common%20Design%20Patterns.md#visitor-pattern)
